...
public class MenuViewMine extends LinearLayout{
	...
	public MenuViewMine(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void initView() {
		...
		mBtn.setText(mContext.getString(R.string.btn_mine));
		...
		String[] items = new String[]{"登陆/注册", "账户管理", "收藏", "下载", "退出"};
